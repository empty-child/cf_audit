...
# '''
download_url = 'https://gitlab.ost.ch/damian.dasser/datajson/-/raw/main/coop_vitality_ch.geojson'
...
# '''
query = '[amenity=pharmacy][name~"Coop*"]'
...
# '''
master_tags = ('name', 'website', 'branch') #TODO
...
def dataset(fileobj):
    ...
    data_url = 'https://gitlab.ost.ch/damian.dasser/datajson/-/raw/main/coop_vitality_ch.geojson'
